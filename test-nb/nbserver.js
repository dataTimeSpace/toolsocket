...
function sendFile(entry) {
    ...
    sock.io('/file', { to: entry.to, fileId: entry.fileId, size: entry.size, sha256, sentAt, type: 'rad' }, null, new Uint8Array(buf.buffer, buf.byteOffset, buf.length));
    fileLog.push({ ...entry, sha256, sentAt, genMs, queuedAfterSend: sock.getBackpressure().queuedBytes });
